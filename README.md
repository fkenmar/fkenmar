...
I actually finished the book Hands on Machine Learning and loved it. I really like how there's no perfect algorithm or architecture for a specific task because it's just a generalization so the program keeps human touch since it's a bit intuitive but also analytic at the same time since we have to analyze our data or do research
